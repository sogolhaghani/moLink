...
def init_paramWN18():
    param = {}
    G, train_list = lg.train('./data/WN18/train.txt', hIndex=0 , rIndex=2, tIndex=1)
    param['graph'] = G
    param['train'] = train_list
    param['validation'] = lg.test('./data/WN18/valid.txt')
    param['test'] = lg.test('./data/WN18/test.txt')
    param['window'] = 1
    param['kns'] = 5
